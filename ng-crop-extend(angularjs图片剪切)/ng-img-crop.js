...
crop.factory('cropArea', ['cropCanvas', function(CropCanvas) {
    ...
    CropArea.prototype._preventBoundaryCollision = function(size) {
        ...
        if(newSizeWidth>canvasW) newSizeWidth=canvasW;
        if(newSizeHeight>canvasH) newSizeHeight=canvasH;
...
crop.directive('imgCrop', ['$timeout', 'cropHost', 'cropPubSub', function($timeout, CropHost, CropPubSub) {
    return {
        ...
        link: function(scope, element /*, attrs*/ ) {
            ...
            if(scope.chargement==null) scope.chargement='图片加载中...';
            var displayLoading = function() {
                element.append('<div class="loading" style="text-align: center; margin-top:20%"><span>'+scope.chargement+'...</span></div>')
            };
